...
mtype ** allocateScoreMatrix(long long int sizeA, long long int sizeB) {
	int i;
...
void initScoreMatrix(mtype ** scoreMatrix,long long int sizeA, long long int sizeB) {
	int i, j;
...
int LCS(mtype ** scoreMatrix,long long int sizeA,long long int sizeB, char * seqA, char *seqB) {
	int i, j;
	for (i = 1; i < sizeB + 1; i++) {
		for (j = 1; j < sizeA + 1; j++) {
